...
<!-- Stylistic choices for the page (buttons, tables, filters) etc-->
<style>
* {
...
<!-- PHP code that reads information and queries the database
    to only find the matching tuples-->
...
<?php
    ...
    $sql = "SELECT Found.Barcode, Found.Year, Found.Found FROM `Found` LEFT JOIN `AllItems` ON AllItems.Barcode =Found.Barcode WHERE Found.Found = 'NO' ";
...
<!-- Javascript code for the filters-->
    <script>
    function myFunction() {
